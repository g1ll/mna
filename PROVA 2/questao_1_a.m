...
U(length(y),:) = 1500;
USAI(:,:,tml+1)=U;
disp('TEMPO SIMULADO (S), ITERAÇÃO'), [tml*deltat tml]
...
caxis([A B])
colorbar
print(strcat('fig_q1_a_',num2str(100+j)),'-dpng','-r300')
close(gcf)
%M(j) = getframe;
end
!convert -delay 50 -loop 0 fig_q1_a_*.png questao_1_a.gif
!rm fig_q1_a_*.png